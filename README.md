...
Spectrometer software stack built around VEYE RAW-MIPI-SC132M and Raspberry Pi Zero 2 W (headless).  
The project provides calibration tooling, spectrum extraction, MQTT control, and optional webserver interfaces for remote operation.
